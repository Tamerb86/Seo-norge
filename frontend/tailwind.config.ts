...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Semantic design tokens — mapped to the CSS variables in globals.css.
        // Space-separated RGB vars enable the `/<alpha>` opacity modifier.
        ...
        // Brand primary: semantic DEFAULT/foreground (var-based) + full scale.
        primary: {
